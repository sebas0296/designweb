...
// primeraCaja.textContent = 'Hola Mundo';  cambiar el contenido de una caja
...
// ----- Conociendo el elemento padre ya que algunos no tenie el id contenedor
	var padre = cajas[0].parentNode;

// ----- Posicionar el elemento antes de otro seleccionado
	// padre.insertBefore(caja, primeraCaja); el primer añadir caja y el segundo es agregarlo antes de la caja con id especifica 
		//						cajas[1]				
